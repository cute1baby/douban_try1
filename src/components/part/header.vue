<template>
  <div class="header-bar">
    ...
    <ul class="nav">
      <li>
        <router-link style="color: #2384E8" :to="{ name: 'MoviesView'}">
          电影
        </router-link>
      </li>
      <li>
        <router-link style="color: #9F7860" :to="{ name: 'BooksView'}">
          图书
        </router-link>
      </li>
      <li>
        <router-link style="color: #E4A813" :to="{ name: 'RadiosView'}">
          广播
        </router-link>
      </li>
      <li>
        <router-link style="color: #2AB8CC" :to="{ name: 'GroupsView'}">
          小组
        </router-link>
      </li>
    </ul>
