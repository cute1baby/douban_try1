...
<style scoped>
  ...
  .register-view form input[type="text"], .register-view form input[type="password"] {
  ...
  .register-view form .form-pwd input, .register-view form .form-name input {
    padding-right: 4rem;
    border-top: 0;
  }
